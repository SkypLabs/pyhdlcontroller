...
htmlhelp_basename = 'HDLControllerdoc'
...
latex_documents = [
    (master_doc, 'HDLController.tex', 'HDLController Documentation',
...
man_pages = [
    (master_doc, 'hdlcontroller', 'HDLController Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HDLController', 'HDLController Documentation',
     author, 'HDLController', 'One line description of project.',
     'Miscellaneous'),
]
